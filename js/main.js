...
output.textContent = "May the best species win!"
...
function playGame(){
  ...
  computer.textContent = `Computer Score: ${compScore}`;
  if (playerScore == 5){
      output.textContent = "You Won the Game! You saved mankind :) GG!!";
      playerScore = 0;
      compScore = 0;
      player.textContent = `Player Score: ${playerScore}`;
      computer.textContent = `Computer Score: ${compScore}`;
      ...
      output.textContent = "You Lost the game. You failed mankind."
      playerScore = 0;
      compScore = 0;
      player.textContent = `Player Score: ${playerScore}`;
      computer.textContent = `Computer Score: ${compScore}`;
